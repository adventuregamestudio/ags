...
extern int32_t ccRegisterManagedObjectAndRef(const void *object, ICCDynamicObject *callback, ScriptValueType obj_type = kScValDynamicObject);
// register a new object and mark it persistent (always referenced by the engine)
extern int32_t ccRegisterPersistentObject(const void *object, ICCDynamicObject *callback, ScriptValueType obj_type = kScValDynamicObject);
