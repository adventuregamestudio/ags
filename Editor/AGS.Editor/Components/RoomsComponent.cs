...
namespace AGS.Editor.Components
{
    class RoomsComponent : BaseComponentWithScripts<IRoom, UnloadedRoomFolder>, IRoomController
    {
        ...
        private bool SaveRoomComponentsAndShowErrors(Room room, RoomSettingsEditor editor, bool onlyIfModified)
        {
            ...
            _guiController.PostOutputAndReportErrors(errors, "when saving the room");
...
#pragma warning restore 0612
        ...
        {
            _agsEditor.Tasks.ScanAndReportMissingInteractionHandlers("Room", "Room",
                    null, -1, room.Number, room.Interactions, room.Script.AutoCompleteData, true, true, errors);
