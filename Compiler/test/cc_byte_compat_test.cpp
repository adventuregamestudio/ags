...
TEST(Bytecode, For3) {
    ...
    intptr_t code[] = {
      38,    0,    3,    1,            2,   63,    4,    1,    // 7
       1,    4,    6,    3,            1,   28,   29,   51,    // 15
       4,   48,    3,   29,            3,    6,    2,    0,    // 23
      48,    3,   30,    4,           15,    4,    3,    3,    // 31
       4,    3,   51,    4,           49,    2,    1,    4,    // 39
      31,   16,   31,  -34,           51,    4,   49,    2,    // 47
       1,    4,    6,    3,           -7,   31,    3,    6,    // 55
       3,    0,    5,  -999
    };
...
TEST(Bytecode, For6) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,          102,   23,    3,    3,    // 7
       1,    2,    8,    3,            1,    1,    4,   51,    // 15
       4,    7,    3,   29,            3,    6,    3,  113,    // 23
      23,    3,   30,    4,           18,    4,    3,    3,    // 31
       4,    3,   28,   62,           51,    4,    7,    3,    // 39
      29,    3,    6,    3,            0,   30,    4,   19,    // 47
       4,    3,    3,    4,            3,   28,   23,   51,    // 55
       4,    7,    3,   29,            3,    6,    3,  124,    // 63
      23,    3,    2,    1,            4,   51,    4,    8,    // 71
       3,    6,    3,    0,           31,  -63,   51,    4,    // 79
       7,    3,   29,    3,            6,    3,  124,   23,    // 87
       3,    2,    1,    4,           51,    4,    8,    3,    // 95
      31,  -83,    2,    1,            4,    5,   38,  102,    // 103
       6,    3,    1,   31,            3,    6,    3,    0,    // 111
       5,   38,  113,    6,            3,   10,   31,    3,    // 119
       6,    3,    0,    5,           38,  124,   51,    8,    // 127
       7,    3,   29,    3,            6,    3,    1,   30,    // 135
       4,   11,    4,    3,            3,    4,    3,   31,    // 143
       3,    6,    3,    0,            5,  -999
    };
...
TEST(Bytecode, Struct01) {
    ...
    intptr_t code[] = {
      38,    0,    3,    1,            2,    4,    4,    0,    // 7
       ...
       3,    4,    0,    6,            2,    0,   47,    3,    // 31
       6,    2,    0,   48,            3,    3,    1,    2,    // 39
      50,    3,   69,    2,            1,    4,   31,   12,    // 47
       6,    3,    0,    3,            1,    2,   50,    3,    // 55
      69,    2,    1,    4,            5,   38,   61,    3,    // 63
       1,    2,   63,    4,            1,    1,    4,   51,    // 71
       4,   29,    6,   29,            2,    6,    3,   -1,    // 79
      30,    2,   29,    3,           45,    2,    6,    3,    // 87
       0,   23,    3,    2,            1,    4,   30,    6,    // 95
       2,    1,    4,    5,          -999
    };
...
TEST(Bytecode, Struct04) {
    ...
    intptr_t code[] = {
      ...
      52,   48,    2,   30,            3,    8,    3,    3,    // 31
       ...
       4,   49,    1,    2,            4,   49,    1,    2,    // 79
       4,   49,   51,   52,            6,    3,    3,   29,    // 87
       2,   29,    3,   49,            1,    2,    4,   49,    // 95
       1,    2,    4,   49,            1,    2,    4,   49,    // 103
      30,    3,   30,    2,            1,    2,   16,    2,    // 111
       3,    1,   70,  -29,           30,    3,    2,    1,    // 119
      64,    5,  -999
    };
...
TEST(Bytecode, Struct06) {
    ...
    intptr_t code[] = {
      38,    0,    3,    1,            2,   63,    4,    1,    // 7
       1,    4,    6,    3,            5,   72,    3,    4,    // 15
       1,   51,    4,   47,            3,   51,    4,   52,    // 23
      48,    2,   29,    2,            6,    3,    3,   71,    // 31
       3,   30,    2,   32,            3,    4,   11,    2,    // 39
       3,   52,   48,    2,            7,    3,    1,    3,    // 47
       1,    8,    3,    6,            3,    0,   51,    4,    // 55
      49,    2,    1,    4,            5,  -999
    };
...
TEST(Bytecode, Struct08) {
    ...
    intptr_t code[] = {
      38,    0,    3,    1,            2,    4,    4,    0,    // 7
       ...
       3,   70,   34,   29,            3,   51,   20,    7,    // 23
       3,   42,    3,   28,           16,   29,    3,    3,    // 31
       6,    2,   52,    7,            3,   30,    4,   21,    // 39
       4,    3,    3,    4,            3,   30,    4,   22,    // 47
       4,    3,    3,    4,            3,   70,   32,   29,    // 55
       3,    6,    3,    0,           29,    3,    3,    6,    // 63
       2,   52,    1,    2,            4,    7,    3,   30,    // 71
       4,   16,    4,    3,            3,    4,    3,   30,    // 79
       4,   22,    4,    3,            3,    4,    3,    2,    // 87
       1,    4,   31,    6,            6,    3,    0,    2,    // 95
       1,    4,    5,  -999
    };
...
TEST(Bytecode, Func01) {
    ...
    intptr_t code[] = {
      ...
      49,    2,    1,   12,           31,   12,    6,    3,    // 63
       0,   51,   12,   49,           51,    8,   49,    2,    // 71
       1,   12,    5,  -999
    };
   ...
   ";
    ...
    intptr_t code[] = {
      ...
      51,   12,    7,    3,           50,    3,    6,    3,    // 15
       ...
       9,    6,    3,    0,           51,    8,   49,   51,    // 31
      12,   49,    5,   38,           35,    3,    1,    2,    // 39
      63,    4,    1,    1,            4,    3,    1,    2,    // 47
      63,    4,    1,    1,            4,   51,    4,   48,    // 55
       3,   29,    3,   51,           12,   48,    3,   29,    // 63
       3,    6,    3,    0,           23,    3,    2,    1,    // 71
       8,    3,    1,    2,            8,    3,    1,    1,    // 79
       4,   51,    4,    7,            3,   51,   12,   49,    // 87
      51,    8,   49,    2,            1,   12,   31,   12,    // 95
       6,    3,    0,   51,           12,   49,   51,    8,    // 103
      49,    2,    1,   12,            5,  -999
    };
...
TEST(Bytecode, Func04) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            5,   29,    3,    6,    // 7
       3,   44,   23,    3,            2,    1,    4,    3,    // 15
       1,    2,   50,    3,            1,    1,    4,    6,    // 23
       3,   -1,   51,    4,           49,    2,    1,    4,    // 31
      31,    9,    6,    3,            0,   51,    4,   49,    // 39
       2,    1,    4,    5,           38,   44,   73,    3,    // 47
       4,    3,    1,    2,           50,    3,   69,   31,    // 55
       9,    6,    3,    0,            3,    1,    2,   50,    // 63
       3,   69,    5,  -999
    };
...
TEST(Bytecode, Static1) {
    ...
    intptr_t code[] = {
      ...
      29,    3,    6,    3,            0,   23,    3,    2,    // 63
       ...
       4,    3,    3,    1,            2,    8,    3,    1,    // 79
       1,    4,   51,    4,            7,    3,   29,    3,    // 87
       6,    3,    5,   29,            3,    6,    3,  100,    // 95
      29,    3,    6,    3,            0,   23,    3,    2,    // 103
       1,    8,   30,    4,           11,    4,    3,    3,    // 111
       4,    3,    2,    1,            4,   31,    6,    6,    // 119
       3,    0,    2,    1,            4,    5,  -999
    };
...
TEST(Bytecode, Attributes01) {
    ...
    intptr_t code[] = {
      ...
      48,    2,   29,    6,           45,    2,   39,    0,    // 119
       ...
       8,   49,    2,    1,            8,   31,   38,    2,    // 135
       1,    4,   51,    4,           52,   48,    2,   29,    // 143
       6,   45,    2,   39,            0,    6,    3,    0,    // 151
      33,    3,   30,    6,           51,    4,   49,    2,    // 159
       1,    4,   31,    9,            6,    3,    0,   51,    // 167
       4,   49,    2,    1,            4,    5,  -999
    };
...
TEST(Bytecode, StringStandard01) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            0,   64,    3,    3,    // 7
       ...
       4,   48,    3,   29,            3,    6,    3,   14,    // 23
      30,    4,   66,    4,            3,    3,    4,    3,    // 31
      28,   11,    6,    3,            1,   51,    4,   49,    // 39
       2,    1,    4,   31,           20,    6,    3,    0,    // 47
      51,    4,   49,    2,            1,    4,   31,    9,    // 55
       6,    3,    0,   51,            4,   49,    2,    1,    // 63
       4,    5,  -999
    };
...
TEST(Bytecode, StringOldstyle05) {
    ...
    intptr_t code[] = {
      38,    0,   51,    8,            7,    3,    5,    6,    // 7
       3,    0,    5,   38,           11,    6,    2,  200,    // 15
       7,    3,   29,    3,            6,    3,    0,   23,    // 23
       3,    2,    1,    4,            6,    3,    0,    5,    // 31
     -999
    };
...
TEST(Bytecode, StringStandard02) {
    ...
    // and append its output below.
    // Then run the test in earnest after changes have been made to the code
    const size_t codesize = 95;
    EXPECT_EQ(codesize, scrip->codesize);

    intptr_t code[] = {
      38,    0,    6,    2,            0,   29,    2,   30,    // 7
       2,   48,    3,    5,            6,    3,    0,    5,    // 15
      38,   16,   51,    8,            7,    3,   50,    3,    // 23
      51,    8,   29,    2,           30,    2,   48,    3,    // 31
      51,    8,   69,    5,            6,    3,    0,   51,    // 39
       8,   69,    5,   38,           43,    6,    3,    7,    // 47
      64,    3,    3,    1,            2,   50,    3,    1,    // 55
       1,    4,   51,    4,           29,    2,   30,    2,    // 63
      48,    3,   51,    4,           69,    2,    1,    4,    // 71
       5,    6,    3,    0,           51,    4,   69,    2,    // 79
       1,    4,    5,   38,           83,    6,    3,    7,    // 87
      64,    3,    5,    6,            3,    0,    5,  -999
    };
    ...
    "String::geti_Chars",         "String::get_Length",         "I",           // 20
     "[[SENTINEL]]"
    };
...
TEST(Bytecode, StringStandardOldstyle) {
    ...
    intptr_t code[] = {
      38,    0,    6,    2,          200,    7,    3,   64,    // 7
       3,    5,    6,    3,            0,    5,   38,   14,    // 15
      51,    8,    7,    3,           50,    3,   51,    8,    // 23
      29,    2,   30,    2,           48,    3,   51,    8,    // 31
      69,    5,    6,    3,            0,   51,    8,   69,    // 39
       5,   38,   41,    6,            3,    6,   64,    3,    // 47
      29,    3,    6,    3,           14,   23,    3,    2,    // 55
       1,    4,    6,    3,            0,    5,   38,   62,    // 63
       6,    3,    6,   64,            3,    3,    1,    2,    // 71
      50,    3,    1,    1,            4,   51,    4,   29,    // 79
       2,   30,    2,   48,            3,   67,    3,   29,    // 87
       3,    6,    3,   41,           23,    3,    2,    1,    // 95
       4,    6,    3,    0,           51,    4,   69,    2,    // 103
       1,    4,    5,  -999
    };
