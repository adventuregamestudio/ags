...
\title{Adventure Game Studio 3.99.99}%
...
Copyright (c) 1999-2011 Chris Jones and 2011-2019 various contributors.
...
\large{Copyright 1999-2011 Chris Jones and 2011-2019 various contributors}\hrule
...
\bf{NOTE:} the previously available "Default" template is now known as "Sierra-style". It also contains updated graphics.

\bf{If the list of templates is empty}

The templates are normally located in "Templates" folder withing AGS Editor directory. If the folder is empty,
this may happen if AGS Editor installation went wrong, or you have used an incomplete package. Try to reinstall AGS, or,
if you have other versions of AGS available, you may simply copy template files from these (ones with AGT extension).
...
\item Sierra-style game template originally worked on by Rui "Trovatore" Pires, enhanced with the new art by ProgZmax, CaesarCub, Hobo, Selmiak and Jim Reed.
