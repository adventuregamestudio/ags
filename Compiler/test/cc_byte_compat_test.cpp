...
TEST(Bytecode, Func01) {
    ...
    intptr_t code[] = {
      38,    0,   51,    0,           63,    4,    1,    1,    // 7
       4,   51,    0,   63,            4,    1,    1,    4,    // 15
       1,    1,    4,   51,            8,   34,    2,   51,    // 23
      12,   34,    2,   39,            2,    6,    3,    0,    // 31
      33,    3,   35,    2,           51,    4,    8,    3,    // 39
      51,    4,    7,    3,           51,   12,   49,   51,    // 47
       8,   49,    2,    1,           12,   31,   12,   51,    // 55
      12,   49,   51,    8,           49,    2,    1,   12,    // 63
       6,    3,    0,    5,          -999
    };
   ...
   ";
    ...
    intptr_t code[] = {
      ...
      51,   12,    7,    3,           50,    3,    6,    3,    // 15
       ...
       1,    1,    4,    1,            1,    4,   51,    8,    // 55
      29,    2,   51,   16,           29,    2,    6,    3,    // 63
       0,   23,    3,    2,            1,    8,   51,    4,    // 71
       8,    3,   51,    4,            7,    3,   51,   12,    // 79
      49,   51,    8,   49,            2,    1,   12,   31,    // 87
      12,   51,   12,   49,           51,    8,   49,    2,    // 95
       1,   12,    6,    3,            0,    5,  -999
    };
...
TEST(Bytecode, AccessStructAsPointer)
{
    ...
    intptr_t code[] = {
      ...
      29,    2,    6,    2,            0,   34,    2,   30,    // 15
       2,   45,    2,   39,            1,    6,    3,    1,    // 23
      33,    3,   35,    1,            6,    3,    0,    5,    // 31
     -999
    };
...
TEST(Bytecode, Struct09) {
    ...
    intptr_t code[] = {
      ...
      51,    4,   47,    3,            1,    1,    4,    6,    // 23
       ...
       7,    3,   46,    3,            6,    6,    2,    4,    // 39
      32,    3,    4,   11,            2,    3,   29,    2,    // 47
       6,    3,    0,   34,            3,    6,    3,    0,    // 55
      34,    3,    6,    3,            3,   29,    3,   51,    // 63
      12,    7,    3,   30,            4,   11,    4,    3,    // 71
       3,    4,    3,   34,            3,    6,    3,    3,    // 79
      34,    3,    6,    3,            7,   29,    3,   51,    // 87
      16,   52,   48,    2,           29,    2,   51,   16,    // 95
       7,    3,   71,    3,           30,    2,   32,    3,    // 103
       4,   11,    2,    3,            7,    3,   30,    4,    // 111
      11,    4,    3,    3,            4,    3,   34,    3,    // 119
       6,    2,    2,   52,           48,    2,   29,    6,    // 127
      45,    2,   39,    0,            6,    3,    0,   33,    // 135
       3,   30,    6,   29,            3,   51,   12,    7,    // 143
       3,   30,    4,   11,            4,    3,    3,    4,    // 151
       3,   46,    3,    7,            6,    2,    1,   32,    // 159
       3,    4,   11,    2,            3,   34,    2,   30,    // 167
       2,   45,    2,   39,            6,    6,    3,    3,    // 175
      33,    3,   35,    6,           51,    8,   49,    2,    // 183
       1,    8,    6,    3,            0,    5,  -999
    };
...
TEST(Bytecode, MemInitPtr1) {
    ...
    intptr_t code[] = {
      38,    0,   51,    0,           63,    4,    1,    1,    // 7
       4,   73,    3,    4,           51,    4,   47,    3,    // 15
       6,    3, 1060320051,   51,            4,   52,   48,    2,    // 23
       8,    3,   51,    0,           63,    4,    1,    1,    // 31
       4,   73,    3,    4,           51,    4,   47,    3,    // 39
       6,    3,    4,   51,            4,   52,   48,    2,    // 47
