...
void engine_init_game_settings()
{
    ...
    set_our_eip(-5);
    // Add all inventory items with "starts with" flag to the player character
    ...
    play.dialog_options_highlight_color = GUI::GetStandardColor(DIALOG_OPTIONS_HIGHLIGHT_COLOR_DEFAULT);
