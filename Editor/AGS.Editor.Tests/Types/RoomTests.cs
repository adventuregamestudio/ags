    ...
    public class RoomTests
    {
            ...
            int topEdgeY, int bottomEdgeY, int number, string description)
        {
            ...
            <Room Version=""{Room.LATEST_XML_VERSION}"">
                ...
                <OnLeaveLeft>room_LeftEdge</OnLeaveLeft>
                <Objects/>
                <Hotspots/>
                <WalkableAreas/>
                <WalkBehinds/>
            ...
            int topEdgeY, int bottomEdgeY, int number, string description)
        {
            ...
            _room.OnLeaveLeft = "room_LeftEdge";
            ...
            Assert.That(doc.SelectSingleNode("/Room/OnLeaveLeft").InnerText, Is.EqualTo("room_LeftEdge"));
        }
    }
}
