...
public:
    ...
    void    AppendFmt(AGS_FORMAT_STRING_ARG const char *fcstr, ...) AGS_FORMAT_STRING(2);
    void    AppendFmtv(AGS_FORMAT_STRING_ARG const char *fcstr, va_list argptr) AGS_FORMAT_STRING_V(2);
    ...
    void    FormatV(AGS_FORMAT_STRING_ARG const char *fcstr, va_list argptr) AGS_FORMAT_STRING_V(2);
