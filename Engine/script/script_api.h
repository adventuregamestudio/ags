...
#define API_SCALL_OBJ_PINT3(RET_CLASS, RET_MGR, FUNCTION) \
    ASSERT_PARAM_COUNT(FUNCTION, 3); \
    return RuntimeScriptValue().SetScriptObject((void*)(RET_CLASS*)FUNCTION(params[0].IValue, params[1].IValue, params[2].IValue), &RET_MGR)
...
#define API_SCALL_OBJAUTO_POBJ_PINT5(RET_CLASS, FUNCTION, P1CLASS) \
    ASSERT_PARAM_COUNT(FUNCTION, 6); \
...
#define API_OBJCALL_VOID_POBJ_PINT3(CLASS, METHOD, P1CLASS) \
    ASSERT_OBJ_PARAM_COUNT(METHOD, 4); \
    METHOD((CLASS*)self, (P1CLASS*)params[0].Ptr, params[1].IValue, params[2].IValue, params[3].IValue); \
    return RuntimeScriptValue((int32_t)0)
...
#define API_OBJCALL_BOOL_PINT2(CLASS, METHOD) \
    ASSERT_OBJ_PARAM_COUNT(METHOD, 2); \
    return RuntimeScriptValue().SetInt32AsBool(METHOD((CLASS*)self, params[0].IValue, params[1].IValue))
...
#define API_OBJCALL_OBJ_POBJ_PINT(CLASS, RET_CLASS, RET_MGR, METHOD, P1CLASS) \
    ASSERT_OBJ_PARAM_COUNT(METHOD, 2); \
    return RuntimeScriptValue().SetScriptObject((void*)(RET_CLASS*)METHOD((CLASS*)self, (P1CLASS*)params[0].Ptr, params[1].IValue), &RET_MGR)
...
#define API_OBJCALL_OBJAUTO_PINT2(CLASS, RET_CLASS, METHOD) \
    ASSERT_OBJ_PARAM_COUNT(METHOD, 2); \
    RET_CLASS* ret_obj = METHOD((CLASS*)self, params[0].IValue, params[1].IValue); \
    return RuntimeScriptValue().SetScriptObject(ret_obj, ret_obj)
...
#define API_OBJCALL_OBJAUTO_PINT4(CLASS, RET_CLASS, METHOD) \
    ASSERT_OBJ_PARAM_COUNT(METHOD, 4); \
    RET_CLASS* ret_obj = METHOD((CLASS*)self, params[0].IValue, params[1].IValue, params[2].IValue, params[3].IValue); \
    return RuntimeScriptValue().SetScriptObject(ret_obj, ret_obj)
