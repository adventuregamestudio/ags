...
GUITextBasedControl::GUITextBasedControl(const ScriptEventSchema *schema)
    : GUIControl(schema)
{
}
...
GUITextFieldControl::GUITextFieldControl(const ScriptEventSchema *schema)
    : GUITextBasedControl(schema)
{
}
