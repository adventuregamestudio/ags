...
\bf{NOTE:} The \it{noloopcheck} keyword must be placed between "function" and the function's name.
...
\helprefn{Speech.PortraitY}{Speech.PortraitY}. When set to \bf{false} the
