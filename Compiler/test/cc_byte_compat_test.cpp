...
TEST(Bytecode, Struct01) {
    ...
    intptr_t code[] = {
      ...
      29,    3,   51,    8,           48,    2,   52,   29,    // 47
       2,    6,    3,    3,           30,    2,   32,    3,    // 55
       4,   71,    3,   11,            2,    3,   30,    3,    // 63
      ...
      45,    2,    6,    3,            0,   23,    3,    2,    // 135
       ...
       1,    1,    4,   51,            8,   48,    2,   52,    // 151
      29,    2,    6,    3,            3,   30,    2,   32,    // 159
       3,    4,   71,    3,           11,    2,    3,    7,    // 167
...
TEST(Bytecode, Struct02) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            5,    6,    2,   68,    // 7
       8,    3,    6,    3,            3,   29,    3,    6,    // 15
       3,    2,    6,    2,           72,   32,    3,    4,    // 23
      46,    3,   20,   11,            2,    3,   30,    3,    // 31
       8,    3,    6,    3,           42,   29,    3,    6,    // 39
       3,    2,    6,    2,           72,   32,    3,    4,    // 47
      46,    3,   20,   11,            2,    3,    7,    3,    // 55
       6,    2,    0,   32,            3,    4,   46,    3,    // 63
      68,   11,    2,    3,           30,    3,    8,    3,    // 71
       6,    3,   19,   29,            3,    6,    2,   68,    // 79
       7,    3,    6,    2,            0,   32,    3,    4,    // 87
      46,    3,   68,   11,            2,    3,   30,    3,    // 95
       8,    3,   31,    0,            5,  -999
    };
...
TEST(Bytecode, Struct04) {
    ...
    intptr_t code[] = {
      ...
      29,    3,    6,    3,            2,   51,   52,   32,    // 47
       3,   16,   46,    3,           48,   11,    2,    3,    // 55
...
TEST(Bytecode, Struct06) {
    ...
    // S1.Array[3] is null, so S1.Array[3].Payload should dump
    ...
    intptr_t code[] = {
      ...
      51,    4,   47,    3,            6,    3,   77,   29,    // 23
       3,   51,    8,   48,            2,   52,   29,    2,    // 31
       6,    3,    3,   30,            2,   32,    3,    4,    // 39
      71,    3,   11,    2,            3,   48,    2,   52,    // 47
      30,    3,    8,    3,           51,    4,   49,    2,    // 55
       1,    4,    6,    3,            0,    5,  -999
    };
...
TEST(Bytecode, Struct07) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            0,   29,    3,    6,    // 7
       3,    1,    6,    2,            0,   32,    3,    8,    // 15
      46,    3,   24,   11,            2,    3,   30,    3,    // 23
       8,    3,    6,    3,           65,   29,    3,    6,    // 31
       3,    1,    6,    2,            0,   32,    3,    8,    // 39
      46,    3,   24,   11,            2,    3,    1,    2,    // 47
       4,   29,    2,    6,            3,    0,   30,    2,    // 55
      46,    3,    3,   11,            2,    3,   30,    3,    // 63
      26,    3,    6,    3,            1,    6,    2,    0,    // 71
      32,    3,    8,   46,            3,   24,   11,    2,    // 79
       3,    1,    2,    4,           29,    2,    6,    3,    // 87
       0,   30,    2,   46,            3,    3,   11,    2,    // 95
       3,   24,    3,   29,            3,    6,    3,   65,    // 103
      30,    4,   12,    4,            3,    3,    4,    3,    // 111
      29,    3,    6,    3,            1,    6,    2,    0,    // 119
      32,    3,    8,   46,            3,   24,   11,    2,    // 127
       3,    1,    2,    4,           29,    2,    6,    3,    // 135
       1,   30,    2,   46,            3,    3,   11,    2,    // 143
       3,   30,    3,   26,            3,    6,    3,    1,    // 151
       6,    2,    0,   32,            3,    8,   46,    3,    // 159
      24,   11,    2,    3,            1,    2,    4,   29,    // 167
       2,    6,    3,    0,           30,    2,   46,    3,    // 175
       3,   11,    2,    3,           24,    3,    2,    3,    // 183
...
TEST(Bytecode, Func10) {
    ...
    intptr_t code[] = {
      ...
      31,    6,    2,    1,            4,    6,    3,    0,    // 23
       ...
       1,    4,    1,    1,            4,   51,    8,   45,    // 39
       2,    6,    3,    0,           23,    3,   29,    3,    // 47
       6,    3,    3,   30,            4,   40,    4,    3,    // 55
       3,    4,    3,   51,            4,    8,    3,   51,    // 63
       4,    7,    3,    2,            1,    8,   31,    6,    // 71
       2,    1,    8,    6,            3,    0,    5,  -999
    };
...
TEST(Bytecode, ArrayOfPointers1) {
    ...
    intptr_t code[] = {
      ...
      29,    3,    6,    3,            9,   30,    4,   18,    // 23
       ...
       6,    2,    0,   32,            3,    4,   46,    3,    // 47
     200,   11,    2,    3,           30,    3,   47,    3,    // 55
      51,    4,    7,    3,            1,    3,    1,    8,    // 63
       3,   31,  -55,    2,            1,    4,    1,    1,    // 71
       4,    6,    3,   10,            6,    2,    0,   32,    // 79
       3,    4,   46,    3,          200,   11,    2,    3,    // 87
...
TEST(Bytecode, ArrayOfPointers2) {
    ...
    intptr_t code[] = {
     ...
     200,    1,    1,    4,            6,    3,    0,   51,    // 15
       ...
       8,   29,    3,   51,            8,    7,    3,   51,    // 47
     208,   32,    3,    4,           46,    3,  200,   11,    // 55
    ...
    1079194419,   30,    4,   55,            4,    3,    3,    4,    // 95
       ...
       3,   29,    3,    6,            3,    5,   51,  204,    // 111
      32,    3,    4,   46,            3,  200,   11,    2,    // 119
       3,   48,    2,   52,           30,    3,    8,    3,    // 127
       6,    3,    0,   29,            3,    6,    3,    4,    // 135
      51,  204,   32,    3,            4,   46,    3,  200,    // 143
...
TEST(Bytecode, ArrayInStruct) {
    ...
    intptr_t code[] = {
      38,    0,   51,    0,           63,    4,    1,    1,    // 7
       ...
       6,    3,    1,   29,            3,   51,    8,   48,    // 23
       2,   52,   29,    2,            6,    3,    4,   30,    // 31
       2,   32,    3,    4,           46,    3,   40,   11,    // 39
...
TEST(Bytecode, Attributes02) {
    ...
    intptr_t code[] = {
      38,    0,   51,    0,           63,    4,    1,    1,    // 7
       ...
       6,    3,   17,   51,            4,   48,    2,   52,    // 23
      29,    6,   29,    3,           45,    2,    6,    3,    // 31
      87,   23,    3,    2,            1,    4,   30,    6,    // 39
      51,    4,   48,    2,           52,   29,    6,   45,    // 47
...
TEST(Bytecode, AccessStructAsPointer)
{
    ...
    // You may put a managed struct without using a *. The * will be implied
...
TEST(Bytecode, Struct09) {
    ...
    intptr_t code[] = {
      38,    0,   51,    0,           63,    4,    1,    1,    // 7
       4,    6,    3,    6,           72,    3,    4,    0,    // 15
      51,    4,   47,    3,            1,    1,    4,    6,    // 23
       3,    5,   51,    4,            8,    3,   51,    4,    // 31
       7,    3,    6,    2,            4,   32,    3,    4,    // 39
      46,    3,   24,   11,            2,    3,   29,    2,    // 47
       6,    3,    0,   34,            3,    6,    3,    0,    // 55
      34,    3,    6,    3,            3,   29,    3,   51,    // 63
      12,    7,    3,   30,            4,   11,    4,    3,    // 71
       3,    4,    3,   34,            3,    6,    3,    3,    // 79
      34,    3,    6,    3,            7,   29,    3,   51,    // 87
      16,   48,    2,   52,           29,    2,   51,   16,    // 95
       7,    3,   30,    2,           32,    3,    4,   71,    // 103
       3,   11,    2,    3,            7,    3,   30,    4,    // 111
      11,    4,    3,    3,            4,    3,   34,    3,    // 119
       6,    2,    2,   48,            2,   52,   29,    6,    // 127
      45,    2,   39,    0,            6,    3,    0,   33,    // 135
       3,   30,    6,   29,            3,   51,   12,    7,    // 143
       3,   30,    4,   11,            4,    3,    3,    4,    // 151
       3,    6,    2,    1,           32,    3,    4,   46,    // 159
       3,   28,   11,    2,            3,   48,    3,   34,    // 167
...
TEST(Bytecode, DynArrayOfPrimitives) {
    ...
    intptr_t code[] = {
      ...
      51,    4,   47,    3,            6,    3,    0,   29,    // 23
       3,   51,    8,   48,            2,   52,   29,    2,    // 31
       6,    3,    7,   30,            2,   32,    3,    2,    // 39
      71,    3,   11,    2,            3,   30,    3,   27,    // 47
       3,   51,    4,   48,            2,   52,   29,    2,    // 55
       6,    3,    7,   30,            2,   32,    3,    2,    // 63
      71,    3,   11,    2,            3,   25,    3,   29,    // 71
       3,   51,    8,   48,            2,   52,   29,    2,    // 79
       6,    3,    3,   30,            2,   32,    3,    2,    // 87
      71,    3,   11,    2,            3,   30,    3,   27,    // 95
...
TEST(Bytecode, ManagedDerefZerocheck) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            1,   29,    3,    6,    // 7
       2,    0,   48,    2,           52,   29,    2,    6,    // 15
       3,    4,   30,    2,           32,    3,    4,   46,    // 23
       3,   40,   11,    2,            3,   30,    3,    8,    // 31
       3,    6,    3,    0,            5,  -999
    };
...
TEST(Bytecode, MemInitPtr1) {
    ...
    intptr_t code[] = {
      38,    0,   51,    0,           63,    4,    1,    1,    // 7
       4,   73,    3,    4,           51,    4,   47,    3,    // 15
       6,    3, 1060320051,   51,            4,   48,    2,   52,    // 23
       8,    3,   51,    0,           63,    4,    1,    1,    // 31
       4,   73,    3,    4,           51,    4,   47,    3,    // 39
       6,    3,    4,   51,            4,   48,    2,   52,    // 47
      26,    3,    1,    1,            4,   51,    8,   48,    // 55
       3,   29,    3,   51,           16,   48,    3,   29,    // 63
       3,    6,    3,   90,           23,    3,    2,    1,    // 71
       8,   51,    4,    8,            3,   51,   12,   49,    // 79
      51,    8,   49,    2,            1,   12,    6,    3,    // 87
       0,    5,   38,   90,           51,    8,    7,    3,    // 95
      50,    3,   51,   12,            7,    3,   50,    3,    // 103
      51,   12,   48,    2,           52,   24,    3,   51,    // 111
       8,   49,   51,   12,           49,   31,    9,   51,    // 119
       8,   49,   51,   12,           49,    6,    3,    0,    // 127
       5,  -999
    };
