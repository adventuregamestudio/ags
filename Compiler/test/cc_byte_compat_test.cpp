...
TEST(Bytecode, DoNCall) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            0,   29,    3,   31,    // 7
       2,   31,   61,    6,            3,  500,   29,    3,    // 15
       6,    2,    0,   24,            3,   30,    4,   14,    // 23
       4,    3,    3,    4,            3,   29,    3,   51,    // 31
       8,    7,    3,   30,            4,   12,    3,    4,    // 39
       8,    3,    6,    2,            0,   24,    3,    2,    // 47
       3,    1,   26,    3,            6,    2,    0,   24,    // 55
       3,   29,    3,    6,            3,    0,   30,    4,    // 63
      17,    4,    3,    3,            4,    3,   70,  -61,    // 71
      51,    4,    7,    3,            2,    1,    4,   31,    // 79
       6,    2,    1,    4,            6,    3,    0,    5,    // 87
      38,   88,   51,    8,            7,    3,   29,    3,    // 95
      51,   12,    7,    3,           30,    4,   41,    4,    // 103
       3,    3,    4,    3,           29,    3,    6,    3,    // 111
       0,   23,    3,    2,            1,    4,   31,    3,    // 119
       6,    3,    0,    5,          -999
    };
...
TEST(Bytecode, DoUnbracedIf) {
    ...
    intptr_t code[] = {
      ...
      31,    2,   31,   61,           51,    4,    7,    3,    // 15
      29,    3,    6,    3,          100,   30,    4,   18,    // 23
       4,    3,    3,    4,            3,   28,   18,    6,    // 31
       3,   10,   29,    3,           51,    8,    7,    3,    // 39
      30,    4,   11,    3,            4,    8,    3,   31,    // 47
       5,    6,    3,    0,           31,  -44,   51,    4,    // 55
       7,    3,   29,    3,            6,    3,   -1,   30,    // 63
       4,   19,    4,    3,            3,    4,    3,   70,    // 71
     -61,    2,    1,    4,            5,  -999
    };
...
TEST(Bytecode, For1) {
    ...
    intptr_t code[] = {
      ...
      29,    3,    6,    3,            7,   30,    4,   12,    // 55
       ...
       3,   28,    8,    2,            1,    4,    6,    3,    // 87
       0,   31,  -63,    2,            1,    4,    6,    3,    // 95
       3,   29,    3,    6,            2,    0,    7,    3,    // 103
      30,    4,   11,    3,            4,    8,    3,   31,    // 111
    -103,    6,    3,    0,           31,    3,    6,    3,    // 119
       0,    5,  -999
    };
...
TEST(Bytecode, IfDoWhile) {
    ...
    intptr_t code[] = {
      ...
      51,    4,    7,    3,           29,    3,   51,   12,    // 71
       ...
       2,    1,   12,   31,           73,    6,    3,    3,    // 111
      29,    3,   51,    8,            7,    3,   30,    4,    // 119
      11,    3,    4,    8,            3,   31,  -82,   31,    // 127
      39,   31,    2,   31,           35,    6,    3,    1,    // 135
      29,    3,   51,    8,            7,    3,   30,    4,    // 143
      11,    3,    4,    8,            3,   51,    4,    7,    // 151
       3,   29,    3,    6,            3,  100,   30,    4,    // 159
      18,    4,    3,    3,            4,    3,   70,  -35,    // 167
       6,    3,    0,    2,            1,   12,   31,    6,    // 175
       2,    1,   12,    6,            3,    0,    5,  -999
    };
...
TEST(Bytecode, Struct02) {
    ...
    intptr_t code[] = {
      ...
      42,   29,    3,    6,            2,   80,    7,    3,    // 31
       6,    2,    0,   32,            3,    4,   46,    3,    // 39
      68,   11,    2,    3,           30,    3,    8,    3,    // 47
       6,    3,   19,   29,            3,    6,    2,   68,    // 55
       7,    3,    6,    2,            0,   32,    3,    4,    // 63
      46,    3,   68,   11,            2,    3,   30,    3,    // 71
       8,    3,   31,    0,            5,  -999
    };
    ...
    intptr_t code[] = {
     ...
     200,    6,    3,    0,           29,    3,   51,    4,    // 15
      ...
      35,   73,    3,    8,           29,    3,   51,    8,    // 39
       7,    3,   51,  208,           32,    3,    4,   46,    // 47
       3,  200,   11,    2,            3,   30,    3,   47,    // 55
       3,   51,    4,    7,            3,    1,    3,    1,    // 63
...
TEST(Bytecode, Switch02) {
    ...
    intptr_t code[] = {
      ...
      31,   28,    6,    3,            0,   31,   -7,    6,    // 23
       3,    0,   51,    4,            8,    3,   31,   14,    // 31
      29,    4,    6,    3,            5,   30,    4,   16,    // 39
       3,    4,   28,  -21,           31,  -28,    2,    1,    // 47
       4,   31,    3,    2,            1,    4,    5,  -999
    };
...
TEST(Bytecode, Struct09) {
    ...
    intptr_t code[] = {
      38,    0,    6,    3,            6,   72,    3,    4,    // 7
       ...
       3,    6,    2,    4,           32,    3,    4,   46,    // 31
       3,   24,   11,    2,            3,   29,    2,    6,    // 39
