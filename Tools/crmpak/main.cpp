...
const char *HELP_STRING =
   //------------------------------------------------------------------------------|
    ...
    "\n"
    "Command options:\n"
    "  --ibpp N               when importing primary room background: convert to\n"
    "                         this color depth (bits per pixel). Secondary back-\n"
    "                         grounds are always converted to match the primary one\n"
