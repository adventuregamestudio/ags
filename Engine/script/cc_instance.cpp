...
const ScriptCommandInfo sccmd_info[CC_NUM_SCCMDS] =
{
    ...
    ScriptCommandInfo( SCMD_WRITELIT        , "memcpy"            , 2, kScOpNoArgIsReg ),
    ScriptCommandInfo( SCMD_RET             , "ret"               , 0, kScOpNoArgIsReg ),
    ScriptCommandInfo( SCMD_LITTOREG        , "li"                , 2, kScOpOneArgIsReg ),
    ...
    ScriptCommandInfo( SCMD_CHECKBOUNDS     , "assertlte"         , 2, kScOpOneArgIsReg ),
    ScriptCommandInfo( SCMD_MEMWRITEPTR     , "ptrset"            , 1, kScOpOneArgIsReg ),
    ScriptCommandInfo( SCMD_MEMREADPTR      , "ptrget"            , 1, kScOpOneArgIsReg ),
    ScriptCommandInfo( SCMD_MEMZEROPTR      , "ptrzero"           , 0, kScOpNoArgIsReg ),
    ScriptCommandInfo( SCMD_MEMINITPTR      , "ptrinit"           , 1, kScOpOneArgIsReg ),
    ScriptCommandInfo( SCMD_LOADSPOFFS      , "ptrstrack"         , 1, kScOpNoArgIsReg ),
    ScriptCommandInfo( SCMD_CHECKNULL       , "ptrassert"         , 0, kScOpNoArgIsReg ),
    ...
    ScriptCommandInfo( SCMD_CREATESTRING    , "newstr"            , 1, kScOpOneArgIsReg ),
