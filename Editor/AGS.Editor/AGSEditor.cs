...
/*			if (true)
        ...
        private void SaveUserDataFile()
        {
            ...
            writer.WriteProcessingInstruction("xml", "version=\"1.0\" encoding=\"" + Encoding.UTF8.WebName + "\"");
            ...
            try
            {
                StreamWriter fileOutput = new StreamWriter(USER_DATA_FILE_NAME, false, Encoding.UTF8);
        ...
        private object SaveGameFilesProcess(object parameter)
        {
            ...
            XmlTextWriter writer = new XmlTextWriter(sw);
            writer.Formatting = Formatting.Indented;
			writer.WriteProcessingInstruction("xml", "version=\"1.0\" encoding=\"" + _game.DefaultEncoding.WebName + "\"");
            writer.WriteComment("DO NOT EDIT THIS FILE. It is automatically generated by the AGS Editor, changing it manually could break your game");
        ...
        private bool WriteMainGameFile(string fileContents)
        {
            ...
            using (StreamWriter fileOutput = new StreamWriter(tempFile, false, _game.DefaultEncoding))
            {
                try
                {
