...
Second is \verb$for$ loop that lets you initialize internal variable, define end condition and write
iteration just in its header:
...
switch (player)
{
case cEgo: Display("cEgo is player character now"); break;
case cJohn: Display("What do you know, player is controlling John now"); break;
case cMary: Display("Mary is under player control at this point"); break;
default:
  Display("I am not really sure who is player controlling, this might be a bug");
  break;
}
\end{verbatim}
