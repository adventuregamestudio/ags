...
#define CHF_BEHINDSHEPHERD  0x4000   // [DYNAMIC] z-sort behind leader when following another char
#define CHF_AWAITINGMOVE    0x8000   // [DYNAMIC] (meaning not clear, investigate)
#define CHF_MOVENOTWALK     0x10000  // [DYNAMIC] do not play walking animation while moving
...
#define CHF_TURNWHENSTAND   0x80000  // Turn step-by-step when changing standing direction
