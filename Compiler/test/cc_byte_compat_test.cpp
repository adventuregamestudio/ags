...
TEST(Compatibility, ArrayOfPointers2a) {
    ...
    // and append its output below.
    // Then run the test in earnest after changes have been made to the code
    const size_t codesize = 80;
    EXPECT_EQ(codesize, scrip->codesize);

    intptr_t code[] = {
      38,    0,    3,    1,            2,   63,   20,    1,    // 7
       1,   20,    6,    3,         1074580685,   29,    3,    6,    // 15
       3,    5,   46,    3,            5,    3,    3,    7,    // 23
      30,    3,   51,   20,           32,    7,    4,   11,    // 31
       2,    7,   29,    2,           30,    2,   29,    3,    // 39
      48,    3,   30,    4,           29,    3,    3,    4,    // 47
       3,   30,    2,   52,            8,    3,    6,    3,    // 55
       0,   51,   20,   69,            1,    2,    4,   69,    // 63
       1,    2,    4,   69,            1,    2,    4,   69,    // 71
       1,    2,    4,   69,            2,    1,   20,    5,    // 79
     -999
    };
