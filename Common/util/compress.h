...
void save_lzw(std::shared_ptr<AGS::Common::Stream> out, const Common::Bitmap *bmpp, const color *pall);
void load_lzw(std::shared_ptr<AGS::Common::Stream> in, Common::Bitmap **bmm, int dst_bpp, color *pall);
void savecompressed_allegro(std::shared_ptr<AGS::Common::Stream> out, const Common::Bitmap *bmpp, const color *pall);
void loadcompressed_allegro(std::shared_ptr<AGS::Common::Stream> in, Common::Bitmap **bimpp, color *pall);
