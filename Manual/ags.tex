...
When specifying file path you may use two special location tags: ILBRK
...
An attempt to write file into game installation directory will make AGS to automatically
remap such path into \verb^$APPDATADIR$^.
...
file for \bf{writing} in the game installation directory, the filepath will be automatically remapped to
...
This works as if \verb^$SAVEGAMEDIR$^ and \verb^$APPDATADIR$^ were redirected to custom location. Redirection is done internally
