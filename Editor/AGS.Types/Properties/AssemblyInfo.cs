...
namespace AGS.Types
{
	public class Version
	{
		...
		public const string AGS_EDITOR_DATE = "June 2010";
		public const string AGS_EDITOR_FRIENDLY_VERSION = "3.2.0";
		public const string AGS_EDITOR_VERSION = "3.2.0.103";
        public const string AGS_EDITOR_COPYRIGHT = "Copyright © 2006-2010 Chris Jones";
	}
}