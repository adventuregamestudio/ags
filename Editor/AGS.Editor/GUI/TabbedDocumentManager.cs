...
namespace AGS.Editor
{
    public partial class TabbedDocumentManager
    {
        ...
        private void TreeContextMenuEventHandler(object sender, EventArgs e)
        {
            ...
            {
                if (Factory.AGSEditor.Settings.DialogOnMultibleTabsClose && MessageBox.Show("Are you sure you want to close all tabs?", "Confirm close", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                    return;                
            ...
            {
                if (Factory.AGSEditor.Settings.DialogOnMultibleTabsClose && MessageBox.Show("Are you sure you want to close all other tabs?", "Confirm close", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                    return;
