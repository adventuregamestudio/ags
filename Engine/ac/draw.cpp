...
void draw_screen_background(Bitmap *ds) {
    ...
    else
    {
        ...
        update_invalid_region_and_reset(ds, -offsetx, -offsety, thisroom.BgFrames[play.bg_frame].Graphic.get());
    }
...
void draw_fps()
{
    ...
    if (fpsDisplay == NULL)
    {
        fpsDisplay = BitmapHelper::CreateBitmap(100, (getfontheight_outlined(FONT_SPEECH) + 5), game.GetColorDepth());
