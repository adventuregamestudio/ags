...
extern System::Drawing::Bitmap^ ConvertBlockToBitmap(AGS::Common::Bitmap *bitmap);
...
SpriteFileReader::SpriteFileReader(System::String ^filename)
{
    ...
    _metrics = new std::vector<AGS::Common::GraphicResolution>();
...
System::Drawing::Bitmap ^SpriteFileReader::LoadSprite(int spriteIndex)
{
    ...
    System::Drawing::Bitmap ^bmp = ConvertBlockToBitmap(sprite.get());
    return bmp;
}
