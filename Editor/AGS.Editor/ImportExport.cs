...
namespace AGS.Editor
{
    public class ImportExport
    {
        ...
        public static CompileMessages ImportOldEditorDatFile(string fileName, Game game, Dictionary<int, Sprite> spriteList)
        {
            ...
            // [UNICODE] TODO: retrieve encoding hint from the game's data (if available)
        ...
        {
            // [UNICODE] TODO: implement encoding hint in the script module's metadata?
            // or alternatively, try converting as if meant for this game's settings?
        ...
        public static void ExportCharacterNewFormat(Character character, string fileName, Game game)
        {
            ...
            XmlTextWriter writer = new XmlTextWriter(fileName, game.DefaultEncoding);
            writer.WriteProcessingInstruction("xml", "version=\"1.0\" encoding=\"" + game.DefaultEncoding.WebName + "\"");
