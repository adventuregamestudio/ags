...
namespace AGS.Editor
{
    ...
    public class AGSEditor : IAGSEditorDirectories
    {
        ...
        */
        ...
        public string GetFirstAvailableScriptName(Game game, string namePrefix, int startIndex = 1, Room room = null)
        {
            ...
            while (!canUseName)
            {
                ...
                canUseName = !game.IsScriptNameAlreadyUsed(tryName, null);
        ...
        {
            return GetFirstAvailableScriptName(CurrentGame, namePrefix, startIndex, room);
        }
