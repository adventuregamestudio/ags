...
void CharacterExtras::ReadFromFile_v321(Stream *in)
{
...
void CharacterExtras::WriteToFile_v321(Stream *out)
{
...
void CharacterExtras::ReadFromSavedGame(Stream *in)
{
    invorder_count = in->ReadInt16();
    in->ReadArrayOfInt16(invorder, invorder_count);    
    width = in->ReadInt16();
    height = in->ReadInt16();
    zoom = in->ReadInt16();
    xwas = in->ReadInt16();
...
void CharacterExtras::WriteToSavedGame(Stream *out)
{
    out->WriteInt16(invorder_count);
    out->WriteArrayOfInt16(invorder, invorder_count);    
    out->WriteInt16(width);
    out->WriteInt16(height);
    out->WriteInt16(zoom);
    out->WriteInt16(xwas);
