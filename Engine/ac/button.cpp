    ...
    int blocking, int direction, int sframe, int volume)
{
    ...
    ValidateViewAnimVLF("Button.Animate", butt->Name.GetCStr(), view, loop, sframe);
    ValidateViewAnimParams("Button.Animate", butt->Name.GetCStr(), repeat, blocking, direction);
