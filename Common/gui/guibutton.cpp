...
GUIButton::GUIButton()
{
    ...
    TextHorPadding = DefaultHorPadding;
    TextVerPadding = DefaultVerPadding;
...
Rect GUIButton::CalcGraphicRect(bool clipped)
{
    ...
    {
        PrepareTextToDraw();
        Rect frame = RectWH(TextHorPadding, TextVerPadding, _width - TextHorPadding * 2, _height - TextVerPadding * 2);
...
void GUIButton::ReadFromSavegame(Stream *in, GuiSvgVersion svg_ver)
{
    ...
    {
        TextHorPadding = in->ReadInt32();
        TextVerPadding = in->ReadInt32();
...
void GUIButton::WriteToSavegame(Stream *out) const
{
    ...
    out->WriteInt32(TextHorPadding);
    out->WriteInt32(TextVerPadding);
...
void GUIButton::DrawText(Bitmap *ds, int x, int y, bool draw_disabled)
{
    ...
    Rect frame = RectWH(x + TextHorPadding, y + TextVerPadding, _width - TextHorPadding * 2, _height - TextVerPadding * 2);
    if (IsPushed && IsMouseOver)
    {
