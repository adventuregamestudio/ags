...
struct TouchPointer
{
    ...
    TouchPointer(int pointer_id, TouchPhase phase, const Point &pos)
        : PointerID(pointer_id), Phase(phase), Position(pos)
    {}
};
...
{
    for (const auto &tp : g_TouchPointers)
    {
