...
namespace AGS.Editor
{
    public class EditorPreferences
    {
        ...
        private string _editorColorTheme = string.Empty;
        ...
        public EditorPreferences(string registryKey)
        {
            ...
            if (key != null)
            {
                ...
                _editorColorTheme = Convert.ToString(key.GetValue("EditorColorTheme", "Vanilla"));
        ...
        public void SaveToRegistry()
        {
            ...
            else
            {
                ...
                key.SetValue("EditorColorTheme", _editorColorTheme);
        ...
        public string EditorColorTheme
        {
            get { return _editorColorTheme; }
            set { _editorColorTheme = value; }
        }
    }
}
