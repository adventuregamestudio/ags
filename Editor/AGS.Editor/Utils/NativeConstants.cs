...
namespace AGS.Editor
{
    public class NativeConstants
    {
        ...
        public static readonly int CHF_TURNWHENSTAND = (int)Factory.NativeProxy.GetNativeConstant("CHF_TURNWHENSTAND");
        ...
        public class GameOptions
        {
            ...
            public static readonly int OPT_CHARTURNWHENSTAND = (int)Factory.NativeProxy.GetNativeConstant("OPT_CHARTURNWHENSTAND");
