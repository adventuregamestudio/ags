...
int get_int_property(AGS::Common::CustomProperties *cprop, const char *property);
void get_text_property(AGS::Common::CustomProperties *cprop, const char *property, char *bufer);
const char* get_text_property_dynamic_string(AGS::Common::CustomProperties *cprop, const char *property);
