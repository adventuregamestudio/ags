...
void RegisterGlobalAPI(ScriptAPIVersion base_api, ScriptAPIVersion /*compat_api*/)
{
    ...
    ScFnRegister global_api[] = {
        ...
        { "GetCharacterAt",           API_FN_PAIR(GetCharIDAtScreen2) },
        ...
        { "GetGUIAt",                 API_FN_PAIR(GetGUIAt2) },
        { "GetGUIObjectAt",           API_FN_PAIR(GetGUIObjectAt) },
        { "GetHotspotAt",             API_FN_PAIR(GetHotspotIDAtScreen2) },
        ...
        { "GetInvAt",                 API_FN_PAIR(GetInvAt2) },
